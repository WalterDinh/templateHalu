...
class CalendarList extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      texts,
      openDate: date,
      monthIndex: date.diffMonths(date) + this.props.pastScrollRange
    };
  ...
  onMonthClicked(index) {
    ...
    console.log('index', index, monthIndex);
    this.listView.scrollToIndex({ index: index + monthIndex, animated: false });
    this.setState({ monthIndex: index + monthIndex });
  }
  ...
  renderCalendar({ item }) {
    return (
      <CalendarListItem
        ...
        onMonthClicked={index => this.onMonthClicked(index)}
        {...this.props}
      />
    );
  }
  ...
  getMonthIndex(month) {
    ...
    // this.setState({ monthIndex: diffMonths });
    return diffMonths;
  }
  ...
  onScrollEnd = e => {
    ...
    this.setState({ monthIndex: pageNum });
  };
